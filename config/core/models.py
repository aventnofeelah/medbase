...
DISEASE_ORIGIN = [
    ...
    ("deficit", "Дефицитное"),
    ("autoimmune", "Аутоиммунное"),
    ("endocrine", "Эндокринное"),
    ("metabolic", "Метаболическое"),
    ("degenerative", "Дегенеративное"),
    ("mental", "Психическое/Нервное"),
    ("unknown", "Неизвестное/Идиопатическое"),
]
